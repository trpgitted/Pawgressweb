            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
              ...
              <div className="md:col-span-2">
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="#history" className="text-white/70 hover:text-white transition-colors">History</a></li>
                  <li><a href="#careers" className="text-white/70 hover:text-white transition-colors">Careers</a></li>
                  <li><a href="#newsroom" className="text-white/70 hover:text-white transition-colors">Newsroom</a></li>
                </ul>
              </div>
