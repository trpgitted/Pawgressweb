...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 font-baloo overflow-hidden">
      ...
      <div className="absolute top-52 left-10 w-40 h-40 animate-paw-fade z-10" style={{animationDelay: '0s', transform: 'rotate(-15deg)'}}>
      ...
      <div className="absolute top-10 right-1/4 w-56 h-56 animate-paw-fade z-10" style={{animationDelay: '0.5s', transform: 'rotate(25deg)'}}>
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-32 h-32 animate-paw-fade z-10" style={{animationDelay: '1s', transform: 'rotate(-30deg)'}}>
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute bottom-40 left-20 w-48 h-48 animate-paw-fade z-10" style={{animationDelay: '1.5s', transform: 'rotate(45deg)'}}>
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute bottom-72 left-1/2 w-36 h-36 animate-paw-fade z-10" style={{animationDelay: '2s', transform: 'rotate(10deg)'}}>
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute bottom-1/3 right-10 w-44 h-44 animate-paw-fade z-10" style={{animationDelay: '2.5s', transform: 'rotate(-40deg)'}}>
        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
